...
{
	  String recordtodelete1,recordtodelete2,recordtodelete3,names;
	public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.details);
        int length=0;
       LinearLayout linearlayout1=(LinearLayout)findViewById(R.id.linearlayoutdatelend);
       LinearLayout linearlayout2=(LinearLayout)findViewById(R.id.linearlayout2moneyindividual);
      ...
      int i;
       ...
       mySQLiteAdapter.openToRead();	
		 Cursor cursor = mySQLiteAdapter.queueAll9(names);
            ...
            ok.setOnClickListener(new View.OnClickListener() {
      			public void onClick(View v) 
      			{
      			    ...
      			    //   System.out.println(recordtodelete);  
      			       mySQLiteAdapter.openToRead();
      			      mySQLiteAdapter.deleteb(recordtodelete1,recordtodelete2,recordtodelete3,names);
